...
app.post('/api/new-record', api.addRecord)
app.post('/api/new-dept', api.addDept)
app.get('/api/consultees', api.getConsultees)
app.post('/api/login', api.login)
// app.get('/api/session', api.checkSession)
// app.get('/api/notifications', api.getNotifications)
// app.get('/api/checknewnotes', api.getNewNotifications)
// app.get('/api/people', api.getPeople)
// app.get('/api/profile/:username', api.getPerson)
// app.get('/api/messages/:username', api.getMessages)
